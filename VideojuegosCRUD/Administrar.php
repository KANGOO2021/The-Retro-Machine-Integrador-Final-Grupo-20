        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="mx-2" data-bs-toggle="modal" data-bs-target="#modal<?php echo $row['id'] ?>"><svg
                                ...
                                <div class="modal-content modal-eliminar">
                                    ...
                                    <div class="modal-footer  d-flex justify-content-center">
                                        ...
                                        <a class="btn btn-danger"
                                            href="Delete.php?id=<?php echo $row['id'] ?>">Eliminar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a href="Update.php?id=<?= $row['id'] ?>" class=""><svg xmlns="http://www.w3.org/2000/svg"
                                width="20px" height="20px" fill="currentColor" class="bi bi-pencil-fill"
                                viewBox="0 0 16 16">
                                <path
