...
<body class="bg-image" >
    <div class="container text center">
        ...
        <form action="moviesUpdate.php?id=<?php echo $pelicula['id_movie'];?>" method="post" enctype="multipart/form-data" class="p-4 bg-white rounded needs-validation" novalidate>
            ...
            <div class="mb-3">
                ...
                <div class="formulario__grupo-input">
                        <select class="formulario__input form-control mb-2" name="calificacion" id="calificacion" required>
                            <option value="<?php echo $pelicula['calificacion'];?>"><?php echo $pelicula['calificacion'];?></option>
