...
<body class="bg-image" style="background-image: url('../img/posters80.jpg'); background-repeat: no-repeat; background-size:cover;">
    ...
    <div class="container col-md-5 mt-5 bg-white py-3 rounded">
        ...
        <div class="d-flex justify-content-center">
            ...
            <form method="post" action="peliculaAlta.php" enctype="multipart/form-data" 80%;" class="needs-validation" novalidate>
                ...
                <div class="formulario__grupo mb-3" id="grupo__imagen" form-group>
                    ...
                    <div class="formulario__grupo-input">
                        <input type="file" class="formulario__input form-control mb-2" name="imagen" id="imagen" required>
                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                        <div class="valid-feedback">Bien</div>
                ...
                <div class="formulario__grupo mb-3" id="grupo__link" form-group>
                    ...
                    <div class="formulario__grupo-input">
                        <input type="text" class="formulario__input form-control mb-2" name="link" id="link" placeholder="Ingrese el link del trailer de la pelicula" required>
                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                        <div class="valid-feedback">Bien</div>
                ...
                <div class="text-center mt-3" form-group>
                    <button type="submit" class="btn btn-success mb-3" style="width: 100%;" name="crearPelicula">Enviar</button>
